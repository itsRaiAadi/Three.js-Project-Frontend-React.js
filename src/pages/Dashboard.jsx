...
import { deleteObjectApi, getObjectsApi, uploadObjectApi } from '../api/objectApi.js';
  ...
  return (
    <div className="dashboard-page">
      <section className="page-header">
        <h1>Dashboard</h1>
        <p className="muted">Upload GLB files, open them in the viewer, and save your interaction state.</p>
      </section>
      ...
      <section className="objects-section">
        ...
        {loading ? (
          ...
          <p className="empty-state">No objects uploaded yet. Upload your first GLB model.</p>
        ) : (
          <div className="object-grid">
            {objects.map((object) => (
              <ObjectCard key={object._id} object={object} onDelete={handleDelete} />
            ))}
          </div>
        )}
      </section>
